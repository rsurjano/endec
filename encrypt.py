...
def extract_pem_files(zip_path, extract_to="keys_temp", password=None):
...
def main():
    try:
        ...
        # Create the 'data-encrypted' directory if it doesn't exist
        encrypted_dir = "data-encrypted"
        os.makedirs(encrypted_dir, exist_ok=True)

        # Move the generated files into the 'data-encrypted' directory
        ...
        # Commit files to Git
        # git_commit(os.path.join(encrypted_dir, os.path.basename(encrypted_file)), encrypt_date_str)
        # git_commit(os.path.join(encrypted_dir, os.path.basename(encrypted_key_file)), encrypt_date_str)
        # git_commit(os.path.join(encrypted_dir, os.path.basename(checksum_file)), encrypt_date_str)
